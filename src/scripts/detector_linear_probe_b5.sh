#!/bin/sh
#SBATCH --output=src/psc_logs/b5_det_lp_%j.out
...
slurm_output_train_mass=src/psc_logs/clip_train/b5_det_lp_mass_$CURRENT.out
slurm_output_train_calc=src/psc_logs/clip_train/b5_det_lp_calc_$CURRENT.out
