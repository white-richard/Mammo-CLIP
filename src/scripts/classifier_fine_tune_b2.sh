#!/bin/sh
#SBATCH --output=src/psc_logs/b2_cls_ft_%j.out
...
slurm_output_train_mass=src/psc_logs/b2_cls_ft_mass_$CURRENT.out
slurm_output_train_calc=src/psc_logs/b2_cls_ft_calc_$CURRENT.out
slurm_output_train_density=src/psc_logs/b2_cls_ft_density_$CURRENT.out
slurm_output_train_cancer=src/psc_logs/b2_cls_ft_cancer_$CURRENT.out
