#!/bin/sh
#SBATCH --output=/Mammo-CLIP/src/psc_logs/b2_cls_ft_%j.out
...
slurm_output_train_mass=/Mammo-CLIP/src/psc_logs/b2_cls_ft_mass_$CURRENT.out
slurm_output_train_calc=/Mammo-CLIP/src/psc_logs/b2_cls_ft_calc_$CURRENT.out
slurm_output_train_density=/Mammo-CLIP/src/psc_logs/b2_cls_ft_density_$CURRENT.out
slurm_output_train_cancer=/Mammo-CLIP/src/psc_logs/b2_cls_ft_cancer_$CURRENT.out
