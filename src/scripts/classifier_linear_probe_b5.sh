#!/bin/sh
#SBATCH --output=src/psc_logs/b5_cls_lp_%j.out
...
slurm_output_train_mass=src/psc_logs/clip_train/b5_cls_lp_mass_$CURRENT.out
slurm_output_train_calc=src/psc_logs/clip_train/b5_cls_lp_calc_$CURRENT.out
slurm_output_train_density=src/psc_logs/clip_train/b5_cls_lp_density_$CURRENT.out
slurm_output_train_cancer=src/psc_logs/clip_train/b5_cls_lp_cancer_$CURRENT.out
