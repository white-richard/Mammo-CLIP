#!/bin/sh
#SBATCH --output=/Mammo-CLIP/src/psc_logs/b5_cls_lp_%j.out
...
slurm_output_train_mass=/Mammo-CLIP/src/psc_logs/clip_train/b5_cls_lp_mass_$CURRENT.out
slurm_output_train_calc=/Mammo-CLIP/src/psc_logs/clip_train/b5_cls_lp_calc_$CURRENT.out
slurm_output_train_density=/Mammo-CLIP/src/psc_logs/clip_train/b5_cls_lp_density_$CURRENT.out
slurm_output_train_cancer=/Mammo-CLIP/src/psc_logs/clip_train/b5_cls_lp_cancer_$CURRENT.out
