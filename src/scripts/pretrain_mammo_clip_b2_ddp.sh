...
#$ -o src/scc_logs/pretrain/fold0_b5_det_$JOB_ID_$JOB_NAME.out       # File name for the stdout output of the job.
...
slurm_output_train1=src/scc_logs/pretrain/fold0_b5_det_$CURRENT_$JOB_NAME.out
...
torchrun --nproc_per_node=4 src/codebase/train.py \
 --config-name pre_train_b2_clip.yaml >$slurm_output_train1
