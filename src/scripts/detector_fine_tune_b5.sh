#!/bin/sh
#SBATCH --output=src/psc_logs/b5_det_ft_%j.out
...
slurm_output_train_mass=src/psc_logs/clip_train/b5_det_ft_mass_$CURRENT.out
slurm_output_train_calc=src/psc_logs/clip_train/b5_det_ft_calc_$CURRENT.out
